...
$url = "http://fishopping.ir/serverHypernetShowUnion/GetAreaStoresList_V2.php";
                     ...
                     <tr>
                        ...
                        <td colspan="2">
                           ...
                           <div class="btn-group d-flex" role="group" aria-label="Basic example" style="width:100%">
                              ...
                              <a type="button" class="btn p-0 py-1 storeAction" title="نمایش روی نقشه" href="http://fishopping.ir/index.php?option=com_content&view=article&id=49&lat=<?= $store["latitude"] ?>&lng=<?= $store["longitude"] ?>&name=<?= $store["ShopName"] ?>" style="flex-grow: 1;">
            ...
            success: function(data) {
               ...
               if (data.length) {
                  ...
                  data.forEach(function(item, index) {
                     ...
                     <img src="http://www.fishopping.ir/images/com_hikashop/upload/${item['file_path']}" class="img-product">
